  ...
  return (
    <section className="relative overflow-hidden bg-laut-950">
      ...
      <div className="wrap relative z-10 py-20 text-center md:py-28">
        ...
        <p data-reveal className="mx-auto mt-3 max-w-[48ch] text-white/75">
          Sepuluh rumah produksi bersatu menjaga tradisi dan kualitas kerupuk kipas. Temukan kisah mereka di halaman produsen.
        </p>
